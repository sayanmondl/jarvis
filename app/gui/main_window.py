...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def make_ui(self, thememode):
        ...
        self.label_holder.setMaximumSize(QtCore.QSize(16777215, 80))
        ...
        # History button
        self.historyButton = HistoryButton(parent=self.centralwidget)
        ...
        # Thememode button
        self.themeButton = ThemeModeButton(parent=self.centralwidget)
        ...
        # Settings button
        self.settingsButton = SettingsButton(parent=self.centralwidget)
